...
namespace UI
{
	...
	UIService::UIService()
	{
		...
		gameplayUI_screen_controller = nullptr;
	...
	void UIService::createControllers()
	{
		...
		gameplayUI_screen_controller = new GameplayUIController();
	}
	...
	void UIService::initializeControllers()
	{
		...
		gameplayUI_screen_controller->initialize();
	}
	...
	IUIController* UIService::getCurrentUIController()
	{
		...
		case GameState::GAMEPLAY:
			return gameplayUI_screen_controller;
	...
	void UIService::destroy()
	{
		...
		delete(gameplayUI_screen_controller);
	}
}